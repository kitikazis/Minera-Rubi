 ...
 */
?>
<?php $bannerImg = $banner['image'] ?? $data['hero']['image']; ?>
<section class="banner" style="background-image:linear-gradient(160deg, rgba(0,0,0,0.78) 0%, rgba(0,0,0,0.55) 55%, rgba(235,175,0,0.10) 100%), url('<?= e($bannerImg) ?>');">
